...
return {
  ...
  -- Go
  { "leoluz/nvim-dap-go", optional = true },
  { "nvim-neotest/neotest-go", optional = true },

  -- Java
  { "mfussenegger/nvim-jdtls", optional = true },
  ...
  -- Ruby
  { "suketa/nvim-dap-ruby", optional = true },
